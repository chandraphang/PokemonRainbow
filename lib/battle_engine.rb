class BattleEngine
  ...
  def auto_battle_valid_next_turn?
    if @pokemon_attacker.current_health_point == 0 || @pokemon_defender.current_health_point == 0
      false
    end
  end

  def auto_battle_next_turn!
